                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('business.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="business_type" class="block mt-1 w-full" type="text" name="business_type" :value="old('business_type')" required autofocus autocomplete="business_type" />
                        ...
                        <div>
                            ...
                            <x-text-input id="address1" class="block mt-1 w-full" type="text" name="address1" :value="old('address1')" required autofocus autocomplete="address1" />
                            <x-input-error :messages="$errors->get('address1')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="address2" :value="__('Address 2')" />
                            <x-text-input id="address2" class="block mt-1 w-full" type="text" name="address2" :value="old('address2')" required autofocus autocomplete="address2" />
                            <x-input-error :messages="$errors->get('address2')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="address3" :value="__('Address 3')" />
                            <x-text-input id="address3" class="block mt-1 w-full" type="text" name="address3" :value="old('address3')" required autofocus autocomplete="address3" />
